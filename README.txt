...
Studio 2.1, and uses Gradle 10.  It uses BuildTools 24.0.1 and
Android SDK 24.  I've run it on a 5X emulator, running Nougat.
Other configurations may work but please test to confirm.  In
particular, some of the code does really horrible things to the UI
thread so it may not work at all on a real device.
